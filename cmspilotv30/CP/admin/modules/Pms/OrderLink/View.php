<?
class CP_Admin_Modules_Pms_OrderLink_View extends CP_Common_Lib_ModuleLinkViewAbstract
{
    function getNew(){
    ...
    */
    function getCourseTraineeSearch(){
        ...
        $addUrl ='index.php?module=pms_orderLink&_spAction=contactNew&showHTML=0&company_id=';
    ...
    */
    function getCourseTraineeSearchForm(){
        ...
        $action ='index.php?module=pms_orderLink&_spAction=traineeSearchResult&showHTML=0';
        $text = "
    ...
    */
    function getSelectedTraineeResult(){
        ...
        if($selectContactIds != ''){
            ...
            $viewUrl ='index.php?module=pms_orderLink&_spAction=contactDetails&showHTML=0&contact_id=';
            $editUrl ='index.php?module=pms_orderLink&_spAction=contactEdit&showHTML=0&contact_id=';
    ...
    */
    function getContactEdit(){
        ...
        $formAction ='index.php?module=pms_orderLink&_spAction=contactSave&showHTML=0';
        $text = "
    ...
    */
    function getContactNew(){
        ...
        $formAction ='index.php?module=pms_orderLink&_spAction=contactAddSubmit&showHTML=0';
        $text = "
            ...
            while ($row = $db->sql_fetchrow($result)) {
                ...
                <tr>
                    ...
                    <select name='course_id_row[]' class='fld_course_id_row'>
                            <option value=''>{$modulesArr['pms_course']['title']}</option>
                    ...
                    <td>
                        ...
                        <select name='level_id[]' class='fld_level_id'>
                            <option value=''>{$modulesArr['pms_level']['title']}</option>
    ...
    function getBulkParentStudentEnrollment(){
        ...
        */
        ...
        if($order_id != ''){
            ...
            $enrollmentYearFld = $formObj->getDDRowByArr('Enrollment Year', 'year_of_enrollment', $cpCfg['m.pms.parent.enrollmentYear'], $cpCfg['m.pms.currentYear']);
            $monthList = $this->getMonthList();
        }
        
        /********************************** STEP 2 ENDS HERE ****************************/

        $addUrl ='index.php?module=pms_orderLink&_spAction=contactNew&showHTML=0&parent_id=';
