<?
class CPL_Admin_Widgets_Hms_DailyCollectionReport_View extends CP_Common_Lib_WidgetViewAbstract
{
    //==================================================================//
    function getWidget() {
        ...
        if($tv['module'] == 'common_dashboard'){
            $heading = "Daily Collection Report last 7 days";
        }else {
    ...
    function getRowsHTML() {
        ...
        foreach($this->model->dataArray as $row){
            ...
            $patient_Link = "index.php?_topRm=main&module=hms_patientVisit&_action=edit&patient_visit_id={$row['patient_visit_id']}";
            $patient_visit = "<a href='{$patient_Link}' target='_blank'><u>VST-{$row['visit_code']}</u></a>";
