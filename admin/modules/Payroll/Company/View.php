<?
class CPL_Admin_Modules_Payroll_Company_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$displayLinkData->getLinkPortalMain('payroll_company', 'payroll_contactLink', 'Contacts Linked', $row)}
        {$media->getRightPanelMediaDisplay('Attachments', 'payroll_company', 'attachment', $row)}
        {$comment->getView(array(
             'roomName' => 'payroll_company'
            ,'recordId' => $record_id
        ))}
        ";
