<?
class CPL_Admin_Modules_Payroll_Company_Functions {
    ...
    function setModuleArray($modules){
        ...
        $modObj = $modules->getModuleObj('payroll_company');
    ...
    function setLinksArray($inst) {
        $linkObj = $inst->getLinksArrayObj('payroll_company', 'payroll_contactLink');
    ...
    function setMediaArray($mediaArr) {
        ...
        $mediaObj = $mediaArr->getMediaObj('payroll_company', 'attachment', 'attachment');
