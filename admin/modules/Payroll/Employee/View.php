<?
class CPL_Admin_Modules_Payroll_Employee_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row){
        ...
        $sqlRelegion            = $fn->getValueListSQL('religion');
        ...
        $sqlQualification       = $fn->getValueListSQL('candidateQualification');
        ...
        if($row['citizen'] == 'EP' || $row['citizen'] == 'SP'){
                    ...
                    <table class='thinlist'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{$formObj->getDateRow('Date of Expiry (YYYY-MM-DD)', 'date_of_expiry', $row['date_of_expiry'])}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class='{$classNric}'>{$formObj->getDateRow('Fin No Expiry Date', 'fin_no_expiry_date', $row['fin_no_expiry_date'])}</div>
                            ...
                            <tr>
                                ...
                                <td>{$formObj->getDateRow('Year of completion', 'year_of_completion1', $row['year_of_completion1'])}</td>
                            </tr>
                            <tr>
                                ...
                                <td>{$formObj->getDateRow('Year of completion', 'year_of_completion2', $row['year_of_completion2'])}</td>
                            </tr>
                            <tr>
                                ...
                                <td>{$formObj->getDateRow('Year of completion', 'year_of_completion3', $row['year_of_completion3'])}</td>
                            </tr>
