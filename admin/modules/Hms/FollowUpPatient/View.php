<?
class CPL_Admin_Modules_Hms_FollowUpPatient_View extends CP_Common_Lib_ModuleViewAbstract
{
    ...
    function getFollowupCalendarView() {
        ...
        CP_Common_Lib_Registry::arrayMerge('inlineScripts', array("
            ...
            cpm.hms.followUpPatient.run(exp);
        "));
    ...
    function getCreateAppointmentRecord(){
        ...
        $formAction = "index.php?_topRm=main&module=hms_followUpPatient&_spAction=createAppointmentRecordSubmit&showHTML=0";
    ...
    function getAddFollowUpDetails(){
        ...
        $formAction = "index.php?_topRm=main&module=hms_followUpPatient&_spAction=addFollowUpDetailsFormSubmit&showHTML=0";
