...
class CPL_Admin_Modules_Hms_Receipt_View extends CP_Admin_Modules_Hms_Receipt_View
{
    ...
    function getGenerateReceiptForm() {
        ...
        if($patient_visit_id != ""){
            $appensqlForDue = "o.patient_visit_id < {$patient_visit_id}";
        }

        if($in_patient_id != ""){
            $appensqlForDue = "o.in_patient_id < {$in_patient_id}";
        }

        if($lab_test_id != ""){
            $appensqlForDue = "o.lab_test_id < {$lab_test_id}";
        }
