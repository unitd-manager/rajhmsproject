...
class CPL_Admin_Modules_Hms_PatientVisit_Controller extends CP_Common_Lib_ModuleControllerAbstract
{
    ...
    function getAddNewMedicalTest() {
        return $this->model->getAddNewMedicalTest();
    }
    ...
    function getSearchPatientDetailsWithAddressStreet(){
        return $this->model->getSearchPatientDetailsWithAddressStreet();
    }
    ...
    function getPrintPrescriptionWithoutHeader() {
        return $this->view->getPrintPrescriptionWithoutHeader();
    }
    ...
    function getCreateVisitRecordNewDirect() {
        return $this->model->getCreateVisitRecordNewDirect();
    }

    function getLetterPadDraftForm() {
        return $this->view->getLetterPadDraftForm();
    }

    function getLetterPadDraftFormSubmit() {
        return $this->model->getLetterPadDraftFormSubmit();
    }

    function getPrintLetterPadDraft() {
        return $this->view->getPrintLetterPadDraft();
    }

    function getRemoveProductLineItem() {
        return $this->model->getRemoveProductLineItem();
    }

    function getAdviceDisplay() {
        return $this->view->getAdviceDisplay();
    }

    function getAddAdvice() {
        return $this->model->getAddAdvice();
    }

    function getRemoveAdvice() {
        return $this->model->getRemoveAdvice();
    }

    function getFollowupDisplay() {
        return $this->view->getFollowupDisplay();
    }
    ...
    function getAdviceSubmit() {
        return $this->model->getAdviceSubmit();
    }

    function getFollowupSubmit() {
        return $this->model->getFollowupSubmit();
    }
}