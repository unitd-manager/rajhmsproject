...
class CPL_Admin_Modules_Hms_Reports_Model extends CP_Common_Lib_ModuleModelAbstract
{
    ...
    function __construct() {
        ...
        $this->reportsArray = array(
           ...
           ,'labReportSummary'        => $this->getReportObj('labReportSummary', 'Lab Report Summary')
           ,'labReport'               => $this->getReportObj('labReport', 'Lab Report')
           ,'drPaymentReport'         => $this->getReportObj('drPaymentReport', 'Dr Payment Report')
           ,'patientVisitByMonth'     => $this->getReportObj('patientVisitByMonth', 'Patient Visit Location Wise')
           ,'inPatientReport'         => $this->getReportObj('inPatientReport', 'In Patient Report')
           ,'attendanceReport'        => $this->getReportObj('attendanceReport', 'Attendance Report')
           ,'balanceSheetReport'      => $this->getReportObj('balanceSheetReport', 'Balance Sheet Report')
           ,'vaccinationReport'       => $this->getReportObj('vaccinationReport', 'Vaccination Report')
