<?
class CPL_Admin_Modules_Hms_Contact_View extends CP_Common_Lib_ModuleViewAbstract
{
    /**
     *
     */
    ...
    function getEdit($row){
        ...
        $companyText = $fn->getRecordDetailLink('hms_company', 'record_id',
    ...
    function getRightPanel($row){
        ...
        $text = "
        {$media->getRightPanelMediaDisplay('Attachments', 'hms_contact', 'attachment', $row)}
        {$comment->getView(array(
             'roomName' => 'hms_contact'
            ,'recordId' => $record_id
        ))}
        ";
