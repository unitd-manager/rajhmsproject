<?
class CPL_Admin_Modules_Hms_ContactLink_Model extends CP_Common_Lib_ModuleLinkModelAbstract
{
    ...
    function getFields(){
        ...
        $fa = $fn->addToFieldsArray($fa, 'labs_supplier_id');
        $fa = $fn->addToFieldsArray($fa, 'medical_supplier_id');
        $fa = $fn->addToFieldsArray($fa, 'medicine_company_id');
